...
function ButtonNavigation() {
    ...
    return isLoaded
        ? (
            <> < nav className={
                cn(
                    "bg-transparent z-10 w-full h-auto flex justify-center fixed inset-x-0 bottom-8" +
                    " transition-all ease-in-out",
                    hiddenButtonNavigation && "-mb-40"
                )
            } > <div
                className={cn(
                    ...
                    <button
                        className="current-selected flex flex-col justify-center items-center"
