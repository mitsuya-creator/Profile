            ...
            <main className="w-11/12 h-full xl:w-8/12 md:flex justify-between">
                <section className="md:w-5/6 mr-5">
                    ...
                    <div className="w-full">
                        <button className="bg-violet-800 p-4 rounded-md text-slate-100  ">Download CV</button>
                        <button className="bg-violet-800 p-4 mx-5 rounded-md text-slate-100  ">Contact</button>
                    </div>
                </section>
