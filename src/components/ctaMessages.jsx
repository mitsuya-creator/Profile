...
function CallToAction() {
    return (
        <div className="w-screen flex justify-center my-11 md:my-11">
            <div className="w-11/12 h-full dark:text-slate-400 xl:w-8/12">
                <p className="mb-3">
                    🌟 Seeking Dynamic Collaborations! 🚀 Let's Create Magic Together! 🌟
                </p>
                <p className="mb-3">
